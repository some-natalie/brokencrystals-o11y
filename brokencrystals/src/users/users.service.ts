    ...
    return this.telemetry.startActiveSpan(
      ...
      async (span) => {
        ...
        span.setAttributes({
          ...
          'user.is_admin': user.isAdmin || false,
          'user.is_basic': isBasicUser,
        ...
        try {
          ...
          this.telemetry.recordUserRegistration(true);

          return u;
        } catch (error) {
          // Record failed user registration
          this.telemetry.recordUserRegistration(false);
